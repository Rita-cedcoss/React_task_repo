...
let indexgrocery; let indexvegies;let indextravelling;let indexmiscel;let amount;let text;let expenseqdata;
const Component1 = () => {
  ...
  <div class="form-control">
     ...
     <div class="form-control">
       ...
       <input type="text" id="text" ref={inpexpense} placeholder="Enter text..." />
     </div>
     <div class="form-control">
     ...
     <div class="form-control">
        ...
        <input type="number" id="amount" ref={inpincome} placeholder="Enter amount..." />
     </div>  
